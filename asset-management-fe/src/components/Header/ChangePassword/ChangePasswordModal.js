            ...
            {!isSubmitted &&
                <Modal.Body>
                    <form onSubmit={formik.handleSubmit}>
                        ...
                        <Form.Group as={Row} className="mb-3" controlId="formComfirmPassword">
                        ...
                        <div className="group-btn col-sm-4">
                            ...
                            <Button className="btn-cancel" type="reset" onClick={handleClose}>
                                Cancel
                            </Button>
                        </div>
                    </form>
